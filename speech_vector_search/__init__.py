...
save_token_data = io.save_token_data
...
__all__ = ["load_token_data", "save_token_data",
    "build_subset_mean_prototypes", "PrototypeIndex",
    "evaluate_same_word_retrieval", "locations"]
